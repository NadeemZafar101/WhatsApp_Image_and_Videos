...
//      nativeAdView.setStarRatingView(ratingBar);
  ...
  public String getTemplateTypeName() {
    if (templateType == R.layout.medium_native_ad_template) {
      return MEDIUM_TEMPLATE;
    } else if (templateType == R.layout.small_native_ad_template) {
    ...
    try {
      templateType =
          attributes.getResourceId(
              R.styleable.TemplateView_gnt_template_type, R.layout.medium_native_ad_template);
    } finally {
      attributes.recycle();
    }
